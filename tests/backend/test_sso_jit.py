"""Tests for SSO just-in-time provisioning.

Covers the OIDC protocol path, protocol isolation, default-role injection,
and behavior when an already-linked user is deprovisioned.

Runs against the testcontainer Postgres provided by tests/backend/conftest.py.
"""
