// Maps action category prefix to a semantic icon + colour so reviewers can
// immediately distinguish notification events from correlation events etc.
...
const ICON_SHIELD =
  "M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.752h-.152c-3.196 0-6.1-1.248-8.25-3.286Z"
...
export function ActionBadge({ action }: { action: string }) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 rounded-md px-2 py-0.5 text-xs font-semibold ${cat.bg} ${cat.text}`}>
