      ...
      {!collapsed && (
        <div className="overflow-hidden rounded-lg border border-[var(--color-border)]">
          <div className="grid grid-cols-2 border-b border-[var(--color-border)] bg-[var(--color-bg-section)]">
            <div className="px-3 py-2 text-2xs font-semibold uppercase tracking-[0.12em] text-[var(--color-text-secondary)] border-r border-[var(--color-border)]">Before</div>
            <div className="px-3 py-2 text-2xs font-semibold uppercase tracking-[0.12em] text-[var(--color-text-secondary)]">After</div>
          </div>
          {rows.map((row) => (
            <div
              key={row.key}
