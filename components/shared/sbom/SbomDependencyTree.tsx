  ...
  return (
    <li>
      ...
      >
        ...
        <span className="text-[12px] text-[var(--color-text-primary)] truncate max-w-[24ch]">
          {node.name}
        </span>
        {node.version && (
  ...
  if (dependencies.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center gap-2 py-10 text-center">
        <p className="text-[13px] text-[var(--color-text-secondary)]">No dependency graph data available.</p>
      </div>
    )
  }
