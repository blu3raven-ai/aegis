    ...
    <div className="flex flex-col gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <select
          ...
          className="w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2 text-[13px] text-[var(--color-text-primary)] outline-none transition-colors focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)]"
        >
      ...
      {selectedRepoId && (
        <div className="flex flex-col gap-1.5">
          ...
          {historyState === "loading" ? (
            <div className="flex items-center gap-2 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2 text-[12px] text-[var(--color-text-tertiary)]">
            ...
            <p className="text-[12px] text-[var(--color-status-critical)]">
