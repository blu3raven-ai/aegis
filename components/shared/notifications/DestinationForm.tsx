...
export function DestinationForm({
  ...
  const [type, setType] = useState<"slack" | "webhook" | "email">(
    initial?.destination_type ?? "slack",
  )
  ...
  const labelClass =
    "block text-[11px] font-semibold uppercase tracking-[0.12em] text-[var(--color-text-secondary)] mb-1.5"
  ...
  return (
    <form onSubmit={(e) => { void handleSubmit(e) }} className="space-y-5">
      ...
      <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-4">
        <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.12em] text-[var(--color-text-secondary)]">
          Event filter
        </p>
