// Destination type icons — Slack, webhook, email
...
const COLORS = {
  slack: "text-[#4a154b]",
  webhook: "text-[var(--color-accent)]",
  email: "text-[var(--color-text-secondary)]",
} as const
...
export function DestinationTypeIcon({
  ...
  return (
    <span className={`inline-flex items-center ${COLORS[type]} ${className}`}>
      {ICONS[type]}
    </span>
  )
}
