export function KpiCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex flex-col rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] px-5 py-3 text-left shadow-[0_28px_80px_rgba(15,23,42,0.06)] transition-colors hover:border-[var(--color-accent)] cursor-pointer"
    >
