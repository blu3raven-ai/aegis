    ...
    <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-[var(--shadow-card)]">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="shrink-0">
          {atRisk ? (
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--color-severity-critical-border)] bg-[var(--color-severity-critical-subtle)] px-3 py-1 text-[12px] font-semibold text-[var(--color-severity-critical)]">
              <span className="h-2 w-2 rounded-full bg-[var(--color-severity-critical)]" />
              At Risk
            </span>
          ) : (
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--color-status-ok-border)] bg-[var(--color-status-ok-subtle)] px-3 py-1 text-[12px] font-semibold text-[var(--color-status-ok)]">
