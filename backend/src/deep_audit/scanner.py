...
def ingest_deep_audit_from_minio(org: str, run_id: str, source_type: str | None = None) -> None:
    ...
    if data is None:
        ...
        update_deep_audit_run(org, run_id, {"status": "failed", "finishedAt": _now_iso(), "error": "No output files found"})
        return
    ...
    if new_findings:
        ...
        for finding in new_findings:
            emit_finding_created(finding=finding, scanner_type="deep_audit", source_component="deep_audit.scanner")
