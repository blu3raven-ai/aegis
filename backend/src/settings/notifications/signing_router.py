...
All endpoints sit under /api/v1/notifications/destinations/{id}/signing-secret
and require the manage_settings permission — the same gate used for destination
management in config_router.py.
...
router = APIRouter(
    prefix="/api/v1/notifications/destinations",
    tags=["notifications"],
)
