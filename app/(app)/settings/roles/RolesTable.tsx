      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          <thead className="bg-[var(--color-surface-raised)]/50 text-[var(--color-text-secondary)] border-b border-[var(--color-border)]">
            <tr>
              <th className="px-6 py-3 font-medium uppercase tracking-wider text-[11px] w-[15%]">Name</th>
              <th className="px-6 py-3 font-medium uppercase tracking-wider text-[11px] w-[45%]">Permissions</th>
              <th className="px-6 py-3 font-medium uppercase tracking-wider text-[11px] w-[15%]">Type</th>
              <th className="px-6 py-3 font-medium uppercase tracking-wider text-[11px] w-[15%]">Created</th>
              <th className="px-6 py-3 font-medium uppercase tracking-wider text-right text-[11px] w-[10%]">Actions</th>
            </tr>
          </thead>
