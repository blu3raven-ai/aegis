...
export default function SbomDiffPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto bg-[var(--color-bg)]">
      {/* Breadcrumb */}
      <div className="flex items-center gap-2 border-b border-[var(--color-border)] bg-[var(--color-surface)] px-5 h-11 text-[12px]">
        <Link
          href="/sbom"
      ...
      {/* Page header */}
      <div className="border-b border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-secondary)]">
              Compare two SBOM snapshots to see package changes
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto w-full max-w-5xl flex-1 px-5 py-6">
        ...
        {reposError && (
          <div className="mb-4 flex items-center gap-3 rounded-xl border border-[var(--color-status-critical)]/30 bg-[var(--color-status-critical)]/5 px-4 py-3">
            ...
            <p className="text-[13px] text-[var(--color-status-critical)]">{reposError}</p>
          </div>
        )}
        ...
        {diffState === "error" && errorMessage && (
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-[var(--color-status-critical)]/30 bg-[var(--color-status-critical)]/5 px-4 py-3">
            ...
            <p className="text-[13px] text-[var(--color-status-critical)]">{errorMessage}</p>
          </div>
        )}
        ...
        {diffState === "idle" && (
          <div className="mt-12 flex flex-col items-center justify-center gap-3 text-center">
            ...
            <p className="max-w-sm text-[12px] text-[var(--color-text-tertiary)]">
