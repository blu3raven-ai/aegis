...
function Toast({ message, onDismiss }: { message: string; onDismiss: () => void }) {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 shadow-[var(--shadow-nav)] text-[13px] text-[var(--color-text-primary)]">
