    ...
    <div className="flex h-full flex-col overflow-y-auto bg-[var(--color-bg)]">
      ...
      <div className="mx-auto w-full max-w-5xl flex-1 px-5 py-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link
            href="/sbom/diff"
            className="inline-flex items-center gap-1.5 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-2.5 py-1 text-[12px] text-[var(--color-text-secondary)] transition-colors hover:border-[var(--color-accent)] hover:text-[var(--color-text-primary)]"
          >
        ...
        {error && (
          <div className="mb-6 flex items-center justify-between gap-3 rounded-xl border border-[var(--color-status-critical)]/30 bg-[var(--color-status-critical)]/5 px-4 py-3">
            ...
            <button
              type="button"
              onClick={() => void load()}
              className="shrink-0 rounded-md border border-[var(--color-status-critical)]/40 px-3 py-1 text-[12px] text-[var(--color-status-critical)] transition-colors hover:bg-[var(--color-status-critical)]/10"
            >
              Retry
            </button>
          </div>
