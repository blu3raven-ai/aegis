  ...
  return (
    <>
      <PageHeader
        ...
        title="Integrations"
        org="Connect Aegis to external tools and services"
      />
      <main className="mx-auto max-w-7xl px-6 py-8 space-y-8">
        {/* Enterprise banner */}
        {!isEnterprise && (
          <div className="flex items-center justify-between rounded-2xl border border-purple-500/20 bg-purple-500/5 px-6 py-4">
            ...
            <Link
              ...
              className="shrink-0 rounded-lg border border-purple-500/20 px-4 py-2 text-sm font-semibold text-purple-500 transition-colors hover:bg-purple-500/5 focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:outline-none"
            >
              Upgrade
            </Link>
          </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {isEnterprise ? (
                            <span className="rounded-full bg-amber-500/10 px-2 py-px text-[10px] font-semibold text-amber-500">
                              Coming soon
                            </span>
                          ) : (
                            <span className="rounded-full bg-purple-500/10 px-2 py-px text-[10px] font-semibold text-purple-500">
                              Enterprise
                            </span>
                          )}
                        </div>
...
// ---------------------------------------------------------------------------
// Integration icons — simple, monochrome, 28x28
// ---------------------------------------------------------------------------
...
function WebhookIcon() {
  return (
    <IconWrapper bg="bg-[var(--color-accent-subtle)]">
...
function ApiKeyIcon() {
  return (
    <IconWrapper bg="bg-amber-500/10">
...
function EmailIcon() {
  return (
    <IconWrapper bg="bg-emerald-500/10">
