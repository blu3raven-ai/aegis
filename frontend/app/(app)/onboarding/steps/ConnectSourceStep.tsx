...
import { PermissionPreviewCard } from "./PermissionPreviewCard"
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-6 md:grid-cols-[1fr_320px]">
        <div className="flex flex-col gap-4">
          <div className="grid gap-3 sm:grid-cols-3">
            {PROVIDERS.map((p) => (
              ...
              >
                <svg className="h-8 w-8 text-[var(--color-text-primary)]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d={p.iconPath} />
                </svg>
        ...
        <PermissionPreviewCard provider={selected} />
      </div>
    </StepLayout>
  )
}
