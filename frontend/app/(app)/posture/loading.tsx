export default function Loading() {
  return (
    <div className="flex h-full flex-col bg-[var(--color-bg)]" aria-busy="true" aria-label="Loading posture">
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="h-72 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] motion-safe:animate-pulse" />
