  ...
  return (
    <ScanProgressContext.Provider value={value}>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 flex flex-col items-end gap-3 p-4 sm:p-6">
        ...
        {showFooter && (
          <div className="pointer-events-auto flex w-[min(26rem,calc(100vw-2rem))] items-center justify-between gap-2 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 shadow-[var(--shadow-nav)]">
            {showCancelAll ? (
              <Button
                variant="ghost"
                size="xs"
