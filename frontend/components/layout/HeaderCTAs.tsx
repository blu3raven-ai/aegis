...
const PILL =
  "inline-flex h-9 items-center gap-1.5 rounded-full border border-[var(--color-border)] px-3 text-xs font-medium text-[var(--color-text-secondary)] transition-colors hover:border-[var(--color-accent)] hover:text-[var(--color-text-primary)]"

export function HeaderCTAs() {
  return (
    <div className="flex items-center gap-2">
      <a href="https://blu3raven.ai/" className={PILL} target="_blank" rel="noopener noreferrer" aria-label="Join Slack community">
        {/* Slack mark */}
      ...
      <a href="https://blu3raven.ai/" className={PILL} target="_blank" rel="noopener noreferrer" aria-label="View GitHub repository">
        {/* GitHub mark */}
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5 shrink-0" aria-hidden="true">
      ...
      <a href="https://blu3raven.ai/" className={PILL} target="_blank" rel="noopener noreferrer" aria-label="View documentation">
