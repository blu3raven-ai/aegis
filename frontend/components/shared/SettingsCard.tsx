...
export function SettingsCard({ eyebrow, title, subtitle, children }: SettingsCardProps) {
  return (
    <Card padding="none" className="rounded-md px-6 py-5">
      <p className="font-mono text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--color-text-secondary)]">{eyebrow}</p>
