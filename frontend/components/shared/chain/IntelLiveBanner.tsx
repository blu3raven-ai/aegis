...
export function IntelLiveBanner({ message, onDismiss }: IntelLiveBannerProps) {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="flex items-center gap-3 border-b border-[var(--color-state-dismissed-border,rgba(168,85,247,0.30))] bg-[var(--color-state-dismissed-subtle,rgba(168,85,247,0.05))] px-5 py-2.5 text-xs"
    >
      <span
