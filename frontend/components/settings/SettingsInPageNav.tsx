...
const ORGANIZATION_GROUPS: NavGroupSpec[] = [
  {
    ...
    items: [
      ...
      { id: "members", href: "#members", label: "Members", icon: ICONS.users },
      { id: "roles", href: "#roles", label: "Roles", icon: ICONS.shieldCheck },
      { id: "teams", href: "#teams", label: "Teams", icon: ICONS.team },
    ],
  },
  {
